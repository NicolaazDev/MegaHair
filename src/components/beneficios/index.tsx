...
export const BenefitsSection: React.FC = () => {
  ...
  return (
    <section className="flex flex-col items-center py-12 px-6 bg-transparent z-40 relative">
      <div className="center-col bg-white p-5 rounded-xl py-10 border border-gray-500 border-solid">
        <h1 className="text-[80px] uppercase leading-[1] font-bold font-montserrat">
          {t("title")}
        </h1>
        <p className="text-lg text-foreground mb-8 text-start max-w-xl">
          {t("subtitle")}
        </p>
        <div className="grid grid-cols-3 max-w-[1440px] w-full mt-10 p-4">
